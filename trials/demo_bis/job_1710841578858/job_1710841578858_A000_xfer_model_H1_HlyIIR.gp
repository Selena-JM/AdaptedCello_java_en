...
set output "job_1710841578858_A000_xfer_model_H1_HlyIIR.eps"
...
set format x ""    
set xlabel '00010001'
set arrow from 0.08552586880815331,0.001 to 0.08552586880815331,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 2.1790459631041688,0.001 to 2.1790459631041688,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.07
ymax = 2.5
K = 0.19
n = 2.6
