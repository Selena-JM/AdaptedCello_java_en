...
set output "job_1710841578858_A000_xfer_model_B3_BM3R1.eps"
...
set format x ""    
set xlabel '11101110'
set arrow from 0.07426687347463189,0.001 to 0.07426687347463189,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 2.2290124878342037,0.001 to 2.2290124878342037,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.01
ymax = 0.8
K = 0.26
n = 3.4
