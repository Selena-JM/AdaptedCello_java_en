...
set output "job_1710841320106_A000_xfer_model_S4_SrpR.eps"
...
set format x ""    
set xlabel '00000001'
set arrow from 0.0930431277149987,0.001 to 0.0930431277149987,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 3.703611620162778,0.001 to 3.703611620162778,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.007
ymax = 2.1
K = 0.1
n = 2.8
