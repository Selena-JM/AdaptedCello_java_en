...
set output "job_1710841320106_A000_xfer_model_H1_HlyIIR.eps"
...
set format x ""    
set xlabel '00010001'
set arrow from 0.11677354003418691,0.001 to 0.11677354003418691,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 0.9067209544816885,0.001 to 0.9067209544816885,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.07
ymax = 2.5
K = 0.19
n = 2.6
