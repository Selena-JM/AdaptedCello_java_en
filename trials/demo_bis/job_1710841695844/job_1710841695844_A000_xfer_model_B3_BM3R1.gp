...
set output "job_1710841695844_A000_xfer_model_B3_BM3R1.eps"
...
set format x ""    
set xlabel '00000001'
set arrow from 0.14305523888089894,0.001 to 0.14305523888089894,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 2.5647885575795026,0.001 to 2.5647885575795026,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.01
ymax = 0.8
K = 0.26
n = 3.4
