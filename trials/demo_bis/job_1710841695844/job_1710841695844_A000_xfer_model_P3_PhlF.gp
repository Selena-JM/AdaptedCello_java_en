...
set output "job_1710841695844_A000_xfer_model_P3_PhlF.eps"
...
set format x ""    
set xlabel '00010001'
set arrow from 0.20927226116834546,0.001 to 0.20927226116834546,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 2.2025306385508596,0.001 to 2.2025306385508596,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.02
ymax = 6.8
K = 0.23
n = 4.2
