...
set output "job_1710841695844_A000_xfer_model_H1_HlyIIR.eps"
...
set format x ""    
set xlabel '11101110'
set arrow from 0.020513075779124576,0.001 to 0.020513075779124576,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 4.073662276155077,0.001 to 4.073662276155077,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.07
ymax = 2.5
K = 0.19
n = 2.6
