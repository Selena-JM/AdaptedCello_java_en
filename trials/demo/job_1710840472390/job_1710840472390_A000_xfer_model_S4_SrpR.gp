...
set output "job_1710840472390_A000_xfer_model_S4_SrpR.eps"
...
set format x ""    
set xlabel '0001'
set arrow from 0.08019514880229614,0.001 to 0.08019514880229614,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 3.780646641445647,0.001 to 3.780646641445647,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.007
ymax = 2.1
K = 0.1
n = 2.8
