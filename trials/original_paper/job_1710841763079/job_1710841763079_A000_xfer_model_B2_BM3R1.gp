...
set output "job_1710841763079_A000_xfer_model_B2_BM3R1.eps"
...
set format x "10^{%L}"    
set format x ""    
set xlabel '0000000010101010'
set arrow from 0.08041528694219591,0.001 to 0.08041528694219591,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 2.5722152869421957,0.001 to 2.5722152869421957,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.005
ymax = 0.5
K = 0.15
n = 2.9
