...
set output "job_1710842173697_A000_xfer_model_S4_SrpR.eps"
...
set arrow from 0.08118667179901841,0.001 to 0.08118667179901841,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 2.507513500512401,0.001 to 2.507513500512401,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.007
ymax = 2.1
K = 0.1
n = 2.8
