...
set output "job_1710750513210_A000_xfer_model_P3_PhlF.eps"
...
set format x ""    
set xlabel '0001'
set arrow from 0.07524873235800965,0.001 to 0.07524873235800965,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 2.168768826654025,0.001 to 2.168768826654025,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.02
ymax = 6.8
K = 0.23
n = 4.2
