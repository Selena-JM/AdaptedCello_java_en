...
//	            System.out.println("component_seq_set : " + component_seq_set);
//	            System.out.println("next_bp : " + next_bp);
...
//            System.out.println("promoter_cd_exists : " + promoter_cd_exists);
//            System.out.println("promoter_cd : " + promoter_cd);
//            System.out.println("protein_cd_exists : " + protein_cd_exists);
//            System.out.println("protein_cd : " + protein_cd);
//            System.out.println("promoter_fc_exists : " + promoter_fc_exists);
//            System.out.println("promoter_fc : " + promoter_fc);
//            System.out.println("protein_fc_exists : " + protein_fc_exists);
//            System.out.println("protein_fc : " + protein_fc);
//            System.out.println("moduleDef : " + _circuit_module_definition);
//            System.out.println("Participant property : " + promoterParticipationID);

            Participation production_promoter = productionInteraction.createParticipation(promoter_fc.getDisplayId(),promoter_fc.getIdentity(),SystemsBiologyOntology.PROMOTER); //promoterParticipationID
            Participation production_regulator = productionInteraction.createParticipation(protein_fc.getDisplayId(),protein_fc.getIdentity(),SystemsBiologyOntology.PRODUCT); //proteinParticipationID
    ...
    public void setRepressionInteractions(ArrayList<Part> plasmid) throws SBOLValidationException {
        ...
        for (String protein_name : _repression_map.keySet()) {
            ...
            Participation repression_regulator = repressionInteraction.createParticipation(protein_fc.getDisplayId(),protein_fc.getIdentity(),SystemsBiologyOntology.INHIBITOR); //proteinParticipationID
	    ...
	    repressionPromoterRoles.add(SystemsBiologyOntology.PROMOTER);
            ...
            if (plasmid_has_promoter) {
                Participation repression_promoter = repressionInteraction.createParticipation(promoter_fc.getDisplayId(),promoter_fc.getIdentity(),repressionPromoterRoles); //promoterParticipationID
            }
        }
    }
    ...
    public void setInducerInteractions(ArrayList<Part> plasmid) throws SBOLValidationException {
		...
		URI ligandRole = URI.create("http://identifiers.org/biomodels.sbo/SBO:0000280");
                ...
                Participation complex_regulator = noncovalentInteraction.createParticipation(protein_fc.getDisplayId(),protein_fc.getIdentity(),ligandRole); //proteinParticipationID
                Participation complex_inducer = noncovalentInteraction.createParticipation(inducer_fc.getDisplayId(),inducer_fc.getIdentity(),ligandRole); //inducerParticipationID
                Participation complex_complex = noncovalentInteraction.createParticipation(complex_fc.getDisplayId(),complex_fc.getIdentity(),complexRole); //complexParticipationID
            }
